...
1. Kör `cloudflare/migrations/0002_password_reset.sql` exakt en gång på befintlig databas, före koddeploy. Befintliga lösenord ändras inte. Nya installationer använder den uppdaterade `cloudflare/infra/schema.sql` och ska inte köra samma migration ovanpå den.
